...
def main():
    ...
    input_doc_path = "2408.09869v5.pdf"
    ...
    # Configure EasyOCR to use local models only
    local_model_path = "../model/"  # <-- replace with your local folder
    from docling.datamodel.pipeline_options import EasyOcrOptions
    pipeline_options.ocr_options = EasyOcrOptions(
        lang=["es"],
        model_storage_directory=local_model_path,
        download_enabled=False  # <-- prevents EasyOCR from downloading weights
    )
