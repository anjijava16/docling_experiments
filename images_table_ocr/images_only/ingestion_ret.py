...
if __name__ == "__main__":
    ...
    print("="*80)
    print("PDF TO CHROMADB - DOCLING INTEGRATION")
    print("="*80)
    print("\nThis script provides two main methods:")
    print("  1. ingest_pdf() - Extract and store PDF in ChromaDB")
    print("  2. retrieve_similar() - Query ChromaDB for similar content")
    
    # Example configuration
    PDF_SOURCE = "https://arxiv.org/pdf/2408.09869"
    
    print("\n" + "="*80)
    print("EXAMPLE: INGESTION")
    print("="*80)
    ...
    stats = ingest_pdf(
        ...
        add_metadata={'source': 'arxiv', 'type': 'research_paper'}
    )
    ...
    print("""
# Import the methods
from your_script import ingest_pdf, retrieve_similar

# 1. Ingest a PDF
stats = ingest_pdf("path/to/document.pdf")

# 2. Search for similar content
results = retrieve_similar("your query", k=5)

# 3. Get results without scores
results = retrieve_similar("your query", k=3, return_scores=False)
